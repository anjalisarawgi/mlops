...
DATA_PATH = "dtu_mlops/data/corruptmnist"
...
if __name__ == "__main__":
    ...
    print(
        f"Shape of a training point {(train_set[0][0].shape, train_set[0][1].shape)}")

    print(
        f"Shape of a test point {(test_set[0][0].shape, test_set[0][1].shape)}")
