...
# check if data is in tensor form
...
# print("Data loaded successfully", train_loader[1][0].shape)
 # load data as tensors form datapath 
...
class Decoder(nn.Module):
    ...
    def forward(self, x):
        ...
        x_hat = torch.sigmoid(self.FC_output(h)).to(DEVICE)
        return x_hat
