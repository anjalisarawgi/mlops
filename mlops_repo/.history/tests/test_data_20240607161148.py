...
def test_data():
    ...
    assert len(train) == 60000, "Dataset did not have the correct number of training samples"
    assert len(test) == 10000, "Dataset did not have the correct number of test samples"
